...
GAT_DIR=/Users/Madan/SFU/Semester3/BigDataSystems/Project/term-project-team-d/code/gatling-charts-highcharts-bundle-3.4.2
...
deploy: appns gw s1 s2 s3 s4 s5 db
...
#
dynamodb-clean:
	$(AWS) cloudformation delete-stack --stack-name db-scp-2021-jan-cmpt-756 || true | tee $(LOG_DIR)/dynamodb-clean.log
...
$(LOG_DIR)/dynamodb-init.log: cluster/cloudformationdynamodb.json
	...
	$(AWS) cloudformation create-stack --stack-name db-scp-2021-jan-cmpt-756 --template-body file://$< || true | tee $(LOG_DIR)/dynamodb-init.log
